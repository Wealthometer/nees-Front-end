...
`}</style>
      ...
      <div className="max-w-7xl mx-auto px-4 py-8 md:py-12">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4">
            ...
            <div className="flex w-full sm:w-auto">
              <input
                ...
                className="flex-1 sm:flex-initial sm:w-64 px-3 md:px-4 py-2 border border-gray-300 rounded-l-lg focus:outline-none focus:ring-2 focus:ring-emerald-500 text-sm"
              />
              <button className="px-4 md:px-6 py-2 bg-emerald-500 text-white rounded-r-lg hover:bg-emerald-600 font-medium text-sm whitespace-nowrap">
                SEND
              </button>
            </div>
          </div>
        ...
        <div className="mt-6 md:mt-8 pt-6 md:pt-8 border-t text-center text-gray-600 text-xs md:text-sm">
          <a target='_blank' href="https://nees-zeta.vercel.app/admin-login.html"> © {new Date().getFullYear()} Copyright Nees Solar Panel</a>
        </div>
      </div>
    </footer>
  )
