        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
          ...
          <div>
            ...
            <div className="flex gap-4 mb-6">
              <button className="flex-1 bg-emerald-500 text-white py-3 rounded-lg font-semibold hover:bg-emerald-600 transition-colors">
                ADD TO CART
              </button>
            ...
            <div className="mt-8 pt-8 border-t">
              <div className="flex gap-6 mb-6">
                <button className="text-gray-700 font-medium border-b-2 border-emerald-500 pb-2">
                  Delivery & return
                </button>
